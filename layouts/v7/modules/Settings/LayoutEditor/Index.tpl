...
{strip}
	<div class="container-fluid main-scroll paddingTop15" id="layoutEditorContainer">
		...
		<div class="widget_header row">
			...
			<div class="col-sm-4">
				<a class="btn addButton btn-default module-buttons"
					href="index.php?module=LayoutEditor&parent=Settings&view=Print">
					<div class="fa fa-download" aria-hidden="true"></div>&nbsp;&nbsp;モジュール一覧出力
				</a>
				<a class="btn addButton btn-default module-buttons"
					href="index.php?module=LayoutEditor&parent=Settings&view=PrintRelation">
					<div class="fa fa-download" aria-hidden="true"></div>&nbsp;&nbsp;関連一覧出力
				</a>
			</div>
		</div>
		<br>
