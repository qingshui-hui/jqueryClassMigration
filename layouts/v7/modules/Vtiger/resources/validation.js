...
// https://stackoverflow.com/a/2457053/20308611
jQuery.extend(jQuery.validator.messages, {
    // required: app.vtranslate("This field is required."),
    // remote: app.vtranslate("Please fix this field."),
    // email: app.vtranslate("Please enter a valid email address."),
    // url: app.vtranslate("Please enter a valid URL."),
    // date: app.vtranslate("Please enter a valid date."),
    // dateISO: app.vtranslate("Please enter a valid date (ISO)."),
    // number: app.vtranslate("Please enter a valid number."),
    // digits: app.vtranslate("Please enter only digits."),
    // creditcard: app.vtranslate("Please enter a valid credit card number."),
    // equalTo: app.vtranslate("Please enter the same value again."),
    // accept: app.vtranslate("Please enter a value with a valid extension."),
	maxlength: jQuery.validator.format(app.vtranslate("Please enter no more than {0} characters.")),
    // minlength: jQuery.validator.format(app.vtranslate("Please enter at least {0} characters.")),
    // rangelength: jQuery.validator.format(app.vtranslate("Please enter a value between {0} and {1} characters long.")),
    // range: jQuery.validator.format(app.vtranslate("Please enter a value between {0} and {1}.")),
    max: jQuery.validator.format(app.vtranslate("Please enter a value less than or equal to {0}.")),
    // min: jQuery.validator.format(app.vtranslate("Please enter a value greater than or equal to {0}."))
});
...
jQuery.validator.addMethod("date", function(value, element, params) {
	...
	}, jQuery.validator.format(app.vtranslate("Please enter the correct date"))
);
...
jQuery.validator.addMethod("currencymax", function(value, element, params) {
	element = jQuery(element);
	var groupSeparator = app.getGroupingSeparator();
	var num = value.replaceAll(groupSeparator, '');
	
	// element.data('rule-currencymax')でも取得可能
	var max = params;
	...
	return true;
	}, jQuery.validator.format(app.vtranslate("Please enter a value less than or equal to {0}."))
);
...
jQuery.validator.addMethod("futureEventCannotBeHeld", function(value, element, params) {
	...
	}, jQuery.validator.format(app.vtranslate('JS_FUTURE_EVENT_CANNOT_BE_HELD'))
);
